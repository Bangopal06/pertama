        ...
        <div class="container">
            ...
            <div style="text-align:center; margin-top:40px; padding-top:25px; border-top:1px solid rgba(255,255,255,0.15);">
                <div style="display:flex; justify-content:center; gap:20px; margin-bottom:15px;">
                    ...
                    <a href="#" style="color:white; font-size:24px; text-decoration:none;" title="Instagram">
                    ...
                    <a href="#" style="color:white; font-size:24px; text-decoration:none;" title="Facebook">
                    ...
                    <a href="#" style="color:white; font-size:24px; text-decoration:none;" title="YouTube">
